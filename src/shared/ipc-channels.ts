...
// sticker manager window
  ...
  MEMORY_PANEL_BACKUP: "memory-panel:backup",
  MEMORY_PANEL_EXPORT: "memory-panel:export",
  MEMORY_PANEL_IMPORT: "memory-panel:import",
  MEMORY_PANEL_EDIT_V2: "memory-panel:edit-v2",
  MEMORY_PANEL_EXPIRE_STATE: "memory-panel:expire-state",
  MEMORY_PANEL_RESTORE_STATE: "memory-panel:restore-state",
  MEMORY_PANEL_FORGET_FRAGMENT: "memory-panel:forget-fragment",
  MEMORY_PANEL_GET_DETAIL: "memory-panel:get-detail",
  MEMORY_PANEL_CONFIRM_PENDING: "memory-panel:confirm-pending",
  MEMORY_PANEL_REJECT_PENDING: "memory-panel:reject-pending",
  MEMORY_PANEL_SET_PAUSED: "memory-panel:set-paused",
  MEMORY_PANEL_OPEN_SOURCE: "memory-panel:open-source",
  MEMORY_PANEL_MERGE_ENTITY: "memory-panel:merge-entity",
  MEMORY_PANEL_MERGE_FRAGMENT: "memory-panel:merge-fragment",
